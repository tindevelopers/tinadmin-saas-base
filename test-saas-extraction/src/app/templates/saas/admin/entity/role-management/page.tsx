...
export default function RoleManagementPage() {
  ...
  const handleSeatChange = (type: "current" | "total", value: number) => {
    const { current, total } = parseSeats(editFormData.seats);
    const newSeats =
      type === "current"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      type="number"
                      defaultValue={parseSeats(editFormData.seats).current.toString()}
                      onChange={(e) =>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      id="edit-seats-total"
                      type="number"
                      defaultValue={parseSeats(editFormData.seats).total.toString()}
                      onChange={(e) =>
